...
//
// Antes esta tela não existia como arquivo (o monitor_screen.dart importava
// um `emotional_record_screen.dart`/`EmotionalHistoryScreen` que nunca foram
// criados). Criada aqui já lendo os registros reais do EmotionalEntryStorage
// (SharedPreferences), em vez de dados mock.
