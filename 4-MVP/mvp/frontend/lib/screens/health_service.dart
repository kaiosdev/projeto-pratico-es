// NOTA: este arquivo está desativado (todo o código abaixo está comentado).
// A integração real com HealthKit/Health Connect depende do pacote `health`
// e de configuração nativa que ainda não foi feita neste projeto (ver os
// detalhes logo abaixo). Enquanto isso, o MonitorScreen usa BPM simulado.
//
// Para ativar:
//   1. Adicionar `health: ^11.1.1` em pubspec.yaml
//   2. Aplicar a configuração nativa descrita abaixo
//   3. Descomentar o código deste arquivo
//   4. Chamar HealthService a partir de monitor_screen.dart
//
...
//
// IMPORTANTE — configuração nativa necessária (não dá para fazer só em
