...
class _SpotifyScreenState extends State<SpotifyScreen>
  ...
  Future<void> _fetchPlaylists() async {
    try {
      final response = await http.get(
        // Endpoint oficial do Spotify para as playlists do usuário
  ...
  Future<void> _fetchLikedTracks() async {
    try {
      final response = await http.get(
        // Endpoint oficial do Spotify para as músicas curtidas
  ...
  Future<void> _fetchPlaylistTracks(String playlistId, String name) async {
    ...
    try {
      final response = await http.get(
        // Endpoint oficial do Spotify, com o ID da playlist selecionada
