...
// `audio_service`, que juntos são o combo padrão pra tocar em segundo
// plano no Flutter) nem arquivos de áudio reais. Este arquivo simula a
// reprodução com um Timer, só pra já entregar toda a experiência de UI
// (biblioteca, player, temporizador) funcionando.
//
// Quando vocês adicionarem áudio de verdade:
//   • adicionar `just_audio` + `audio_service` ao pubspec.yaml;
//   • trocar `_SimulatedPlayer` por um AudioPlayer real apontando pra URL
