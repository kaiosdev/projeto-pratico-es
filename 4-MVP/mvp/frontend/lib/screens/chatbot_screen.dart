...
// simples (_LocalChatEngine), só pra já entregar a experiência completa de
// chat (bolhas, histórico, estilo, encaminhamento para ajuda) funcionando
// de ponta a ponta sem depender de nenhuma chave de API.
//
// Quando vocês ligarem numa IA de verdade (ex: API da Anthropic/OpenAI):
...
//     (que guarda a chave em segredo), e o backend repassa pra IA.
