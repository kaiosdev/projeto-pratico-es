...
// `dio`/`http` sendo usados pra salvar arquivos em disco, e não existe
...
//
// Quando vocês implementarem downloads reais (meditações, músicas,
...
class OfflineSettings {
  ...
  static Future<OfflineSettings> load() async {
    ...
    if (itemsStr != null && itemsStr.isNotEmpty) {
      ...
      // Conteúdo de exemplo, só pra ilustrar o gerenciamento (remover
